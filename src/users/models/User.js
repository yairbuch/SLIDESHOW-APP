...
class User {
  ...
  checkPhone(phone) {
    ...
    /**** I canceled the conditions and the eror messages because we decided it's not a required fields ****/
  ...
  checkAddress(address) {
    ...
    /**** I canceled the conditions and the eror messages because we decided it's not required fields ****/
